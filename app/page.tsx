...
const basePath = '/cnno-1775721261240';
...
export default function Home() {
  ...
  const products = [{ n: 'OG Rolls', d: 'Our signature OG Rolls are a masterclass in traditional baking, with a delicate balance of sweet and savory flavors that will transport you to a world of comfort and delight. Made with love and care, these classic treats are perfect for anyone looking to indulge in a timeless favorite.', i: 'https://images.pexels.com/photos/30666844/pexels-photo-30666844.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'domain' }, { n: 'Pistachio Rolls', d: 'For those with a penchant for nuts, our Pistachio Rolls offer a delicious twist on the classic recipe, with a generous helping of crunchy pistachios adding texture and flavor to our signature sweet rolls. Whether you\'re a pistachio aficionado or just looking to try something new, these rolls are sure to satisfy.', i: 'https://images.pexels.com/photos/36835363/pexels-photo-36835363.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'architecture' }, { n: 'Chocolate Rolls', d: 'Indulge in the richness of our Chocolate Rolls, where decadent chocolate meets fluffy, buttery pastry to create a truly irresistible treat. Perfect for chocolate lovers of all ages, these rolls are a chocoholic\'s dream come true.', i: 'https://images.pexels.com/photos/7916094/pexels-photo-7916094.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'chair' }, { n: 'Baby Rolls', d: 'Our adorable Baby Rolls are the perfect snack for kids and adults alike, with a bite-sized bundle of joy that\'s easy to eat on-the-go. Soft, fluffy, and full of flavor, these miniature marvels are sure to put a smile on everyone\'s face.', i: 'https://images.pexels.com/photos/5507697/pexels-photo-5507697.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'eco' }, { n: 'Party Box', d: 'Whether you\'re celebrating a special occasion or just want to treat your friends and family to something truly special, our Party Box is the ultimate solution. Packed with an assortment of our signature rolls, this generous offering is sure to be the life of the party and leave everyone feeling delighted and satisfied.', i: 'https://images.pexels.com/photos/11484120/pexels-photo-11484120.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'precision_manufacturing' }];
            ...
            <div className="lg:col-span-5 space-y-8">
              ...
              <div className="grid grid-cols-2 gap-8 pt-8">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-on-surface-variant">To craft exceptional sweet rolls that bring warmth and comfort to our customers, while fostering a sense of community and excellence in the artisanal baking industry.</p>
                </div>
                <div className="space-y-2">
